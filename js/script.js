...
<div class="col-auto topheadLinks">
    <a target="_blank" href="tel:yourNumber" id="header-mobile-href"><i class="fa-solid fa-phone" aria-hidden="true"></i><span id="header-mobile"> YourNumber</span></a>
    <a target="_blank" href="header_email_href" id="header-email-href"><i class="fa-solid fa-envelope"></i> <span id="header-email">Yor@Email.com</span></a>
  </div>
  <div class="col-auto topheadSocial">
    <a target="_blank" href="https://www.facebook.com/" id="header-facebook-href"><i class="fa-brands fa-facebook"></i></a>
    <a target="_blank" href="https://www.instagram.com/" id="header-instagram-href"><i class="fa-brands fa-square-instagram"></i></a>
    <a target="_blank" href="https://in.linkedin.com/" id="header-linkedin-href"><i class="fa-brands fa-linkedin"></i></a>
    </div>
</div>
            </div>
            </div>
        <div id="main-header">
            ...
            <div class="container header">
                <a class="brandLogo" href="index.html">
                  <img src="image/BrandLogo.webp" id="header-logo" alt="your Logo">
                </a>
                ...
                <ul class="navMenu ms-auto mb-2 mb-lg-0">
                  ...
                  <a href="#" class="navLink">Programs & Plans
                    ...
                    <ul class="dropdownList">
                      <li class="navLi"><a href="careerConsultancy.html" class="navLink" id="service-page-1">Career Consultancy</a></li> 
                      <li class="navLi"><a href="lifePurposeDiscovery.html" class="navLink" id="service-page-2">Life Purpose Discovery</a></li> 
                      <li class="navLi"><a href="interviewPreparation.html" class="navLink" id="service-page-3">Interview Preparation</a></li> 
                      <li class="navLi"><a href="workLifeBalance.html" class="navLink" id="service-page-4">Work-Life Balance</a></li> 
                      </ul>
                      </li>
...
Main Road, Vadodara,391410
                      ...
                      <li>
                      <a href="" class="footerLinks" id="footer-mobile-href">
      ...
      <div class="col-12">
      <div class="inner">
      <div class="copyright text-center"> <span class="year"></span>  All Rights Reserved by <span id="footer-copyright">CompanyName</span> | Developed by <a href="https://shriiitrackingsolution.in/" target="_blank">
  ...
  document.getElementById("fabContainer").innerHTML = ` <!-- whatsapp FAB icon -->
    <div class="fab-container">
      <a class="set-url-target" rel="noopener" data-mobile-target="" data-desktop-target="_blank" target="_blank" id="fabicon-whatsapp-href" href="https://api.whatsapp.com/send?phone=number">
...
fetch("https://script.google.com/macros/s/AKfycbwQCwVWRR8nFVZRYY0bVl3NBcykxJNybLyf-KbQXbEIvfw9l8-uAZ2fWeR4Xjr6v0qn/exec")
  ...
  .then(data => {
    ...
    document.getElementById("service-page-1").textContent = data.service_page_1;
    document.getElementById("service-page-2").textContent = data.service_page_2;
    document.getElementById("service-page-3").textContent = data.service_page_3;
    document.getElementById("service-page-4").textContent = data.service_page_4;

    document.getElementById("header-mobile").textContent = data.header_mobile;
    document.getElementById("header-mobile-href").href = `tel:${data.header_mobile_href}`;
    ...
    document.getElementById("footer-service-1").textContent = data.footer_service_1;
    document.getElementById("footer-service-2").textContent = data.footer_service_2;
    document.getElementById("footer-service-3").textContent = data.footer_service_3;
    document.getElementById("footer-service-4").textContent = data.footer_service_4;
...
const whatsAppNumber= data.fabicon_whatsapp_href;

(function () {
  const mobileLink = `https://api.whatsapp.com/send?phone=${whatsAppNumber}`;
  const desktopLink = `https://web.whatsapp.com/send?phone=${whatsAppNumber}`;
